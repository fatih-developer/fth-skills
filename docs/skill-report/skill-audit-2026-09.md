...
- [ ] **P0-1 · Geçersiz YAML frontmatter:** `project-analyzer`, `proje-analizcisi`
...
- [ ] **P0-2 · Yanlış skill adına işaret eden `default_prompt`:** `ecosystem-api`, `ecosystem-database`, `ecosystem-mobile`, `ecosystem-orchestration`
...
- [ ] **P0-3 · Script'ler runtime'a özgü sabit bir yoldan çağrılıyor:** `project-analyzer`, `proje-analizcisi`
...
- [ ] **P0-4 · `install_all.py` çalışmıyor ve riskli talimat içeriyor:** 4 `ecosystem-*` skill'i
...
- [ ] **P0-5 · Var olmayan bir dosyanın zorunlu okunması:** `task-decomposer`
...
- [ ] **P0-6 · Kırık referans:** `skill-security`
...
- [ ] **P0-7 · Commit edilmiş derleme çıktısı:** `session-transfer`
...
- [ ] **P1-2 · Tetikleme ifadesi olmayan açıklamalar:** 47 skill (tabloda `T` kodu)
...
- [ ] **P1-3 · Birbirini kopyalayan veya çakışan skill'ler**
  | Grup | Sorun | Öneri |
  |---|---|---|
...
- [ ] **P1-4 · Davranışı tümden değiştiren skill'ler örtük tetiklemeye açık**
...
- [ ] **P1-5 · İzinsiz yazma ve yıkıcı işlemler**
...
- [ ] **P1-7 · Taşınabilir olmayan yollar ve runtime'a özgü ifadeler**
...
- [ ] **P2-1 · İç içe code fence render hatası:** 17 skill (`F`)
...
- [ ] **P2-2 · Cümle ortasında kesilmiş `short_description`:** 29 skill (`S`)
...
- [ ] **P2-3 · Handoff bölümü olmayan skill'ler:** 59 skill (`H`)
...
- [ ] **P2-4 · Bağlantısız (orphan) referans dosyaları:** 12 skill (`O`)
...
- [ ] **P2-5 · İnce API/DB skill'leri:** 20 skill (API 10 + DB 10; `pgbouncer-architect` ve `sqlite` hariç)
...
- [ ] **P2-6 · Aşırı uzun SKILL.md:** `b2b-founder-roadmap` (1001), `project-focus-first` (615), `security-auditor` (565), `pgbouncer-architect` (555)
...
- [ ] **P2-7 · Eskiyen statik içerik:** `pgbouncer-architect`, `skill-comparator`
...
- [ ] **P2-8 · `coolify-orchestrator` açıklaması zayıf**
...
- [ ] **P2-11 · `turkish-prompt-compiler` token sayımı**
...
- [ ] **P2-12 · README'deki "Experimental" bölümü**
...
- [ ] **P3-2 · Doğrulayıcıyı güçlendirmek** (`scripts/validate_curated_skills.py`):
...
- [ ] **P3-3 · CI:** Doğrulayıcıyı her push ve PR'da çalıştıran bir GitHub Actions iş akışı. Şu an repoda `.github/` klasörü yok.
- [ ] **P3-4 · Eskimiş dokümanlar:** `docs/analyze/*` (2026-04, 61 skill, Windows yolu) ve AGENTS.md'deki skill sayısı ile ECOSYSTEM.md anlatımı güncellenmeli.
