...
- `references/EXAMPLES.md` — tool plans, blocked calls, and optimizations for common multi-step requests. Read it when the expected output format or level of detail is unclear.
...
**Workflows:**
- **Complex Task Execution Flow** (`orch-complex-task`, step 3 of 6): next → `@memory-ledger`.
