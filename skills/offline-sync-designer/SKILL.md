...
description: "Design local-first and offline sync for mobile apps: storage choice, optimistic UI, conflict resolution policies, and background sync. Use when the app must work without network, the user reports sync conflicts or lost edits, or asks how to add offline mode."
---
