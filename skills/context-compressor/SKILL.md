...
- `references/EXAMPLES.md` — a before-and-after conversation history compression. Read it when the expected output format or level of detail is unclear.
...
**Workflows:**
- **Failure & Context Pressure Flow** (`orch-resilience`, step 2 of 3): next → `@session-transfer` *(optional)*.
