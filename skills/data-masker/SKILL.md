---
name: data-masker
description: "Detect PII in production data (emails, national IDs, card numbers, phone numbers) and design masking for non-production copies: deterministic substitution, partial redaction, shuffling, or hashing, with executable SQL. Use when the user needs a safe staging or test copy of production, GDPR/KVKK-compliant data sharing, or anonymized datasets."
---
