...
description: "Design and review web interfaces with trend-aware, performance-conscious, accessible rules. Use when the user asks to design a page, build UI, create a landing page or dashboard, review or audit an existing site or page, or check a dashboard's usability."
---
...
**Workflows:**
- **Product Page Build Flow** (`web-build-page`, step 2 of 4): next → `@claude-style-coding`.
- **UI Review Flow** (`web-review`, step 1 of 2): last step → summarize the workflow outcome.
