...
- `references/EXAMPLES.md` — a complete retrospective of a skill-development session, showing scores, findings, and action items. Read it when the expected output format or level of detail is unclear.
...
**Workflows:**
- **Complex Task Execution Flow** (`orch-complex-task`, step 6 of 6): last step → once it passes, complete the workflow and report the outcome.
