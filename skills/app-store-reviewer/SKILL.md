...
description: "Check an app against App Store and Google Play review guidelines before submission, diagnose rejection reasons, and optimize store metadata (title, screenshots, description, privacy disclosures). Use when the user is preparing a store submission, received a rejection, or wants a store-readiness review."
---
...
**Workflows:**
- **Production Release Flow** (`mobile-release`, step 1 of 3): next → `@release-orchestrator`.
