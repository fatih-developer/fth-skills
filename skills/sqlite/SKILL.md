...
| File | When to Read |
|---|---|
| `references/README.md` | Index of the reference files with a decision tree for which one to read |
...
**Workflows:**
- **New Schema Design Flow** (`db-new-schema`, step 1 of 4): next → `@schema-architect`.
