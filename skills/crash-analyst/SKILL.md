---
name: crash-analyst
description: "Analyze mobile crash reports from Crashlytics, Sentry, or raw logs: symbolicate iOS traces and deobfuscate Android ProGuard/R8 stacks, isolate the exception, and propose a code-level fix. Use when the user shares a stack trace, crash log, ANR, or crash-rate spike from an iOS, Android, React Native, or Flutter app."
---
...
**Workflows:**
- **Post-Launch Monitoring Flow** (`mobile-post-launch`, step 1 of 3): next → `@mobile-perf-auditor` *(optional)*.
