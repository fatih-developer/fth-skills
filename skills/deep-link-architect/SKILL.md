...
description: "Design iOS Universal Links and Android App Links end to end: URL schema, apple-app-site-association and assetlinks.json, entitlements and manifests, in-app routing, web fallbacks, and test cases. Use when the user needs links, QR codes, emails, or notifications to open a specific app screen, or deep links are not working."
---
...
**Workflows:**
- **Feature Architecture Flow** (`mobile-feature-architecture`, step 1 of 4): last step → once it passes, complete the workflow and report the outcome.
