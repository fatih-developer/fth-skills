...
- `references/EXAMPLES.md` — dependency graphs and parallel execution plans for real tasks. Read it when the expected output format or level of detail is unclear.
