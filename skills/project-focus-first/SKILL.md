...
**Workflows:**
- **Clarification Gate Flow** (`reason-clarify`, step 1 of 3): next → `@ask-first-act-later` *(optional)*.
- **Product Launch Flow** (`product-launch`, step 1 of 5, via `@ecosystem-product`): next → `@b2b-founder-roadmap`.
