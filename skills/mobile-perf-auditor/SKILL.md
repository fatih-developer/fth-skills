...
description: "Audit mobile app performance across cold start, frame drops and jank, memory leaks, battery drain, and bundle size; interpret profiler output and prescribe platform-specific fixes. Use when an iOS, Android, React Native, or Flutter app is slow, janky, crashes from memory, drains battery, or is too large."
---
