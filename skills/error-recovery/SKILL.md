...
- `references/EXAMPLES.md` — classified failures (transient, configuration, logic) and the recovery taken for each. Read it when the expected output format or level of detail is unclear.
...
**Workflows:**
- **Failure & Context Pressure Flow** (`orch-resilience`, step 1 of 3): next → `@context-compressor` *(optional)*.
