...
description: "Audit mobile UI for iOS VoiceOver, Android TalkBack, and WCAG mobile criteria; find missing labels, small touch targets, and contrast problems, and propose accessible code. Use when the user asks for an accessibility or a11y review of a React Native, Flutter, SwiftUI, or Jetpack Compose screen, or before a mobile release."
---
...
**Workflows:**
- **Pre-Release Audit Flow** (`mobile-pre-release-audit`, step 1 of 3): last step → once it passes, complete the workflow and report the outcome.
