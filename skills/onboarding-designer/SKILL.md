...
description: "Design the first-run experience for mobile apps: value discovery, registration strategy, permission sequencing, empty states, and day 1-3 retention hooks. Use when the user is building or improving onboarding, sign-up flow, permission prompts, or early retention."
---
...
**Workflows:**
- **Feature Architecture Flow** (`mobile-feature-architecture`, step 4 of 4): last step → once it passes, complete the workflow and report the outcome.
