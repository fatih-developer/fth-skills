...
- `references/EXAMPLES.md` — domain-specific resource and tool-manifest designs for agent integrations. Read it when the expected output format or level of detail is unclear.
...
**Workflows:**
- **Agent Connectivity Flow** (`orch-agent-connectivity`, step 1 of 3): next → `@auth-flow-designer` *(optional)*.
