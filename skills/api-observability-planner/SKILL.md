...
description: "Plan API observability: RED metrics, structured log format, distributed tracing across service boundaries, and SLO-based alerts. Use when the user asks how to monitor an API, what to log or trace, how to set alerts or SLOs, or to make an API production-ready."
---
