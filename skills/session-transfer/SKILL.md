...
description: 'Create and resume from session handoff documents for seamless AI agent session transfers. Triggers on save state, create handoff, I need to pause, context is getting full, load handoff, continue where we left off. Solves long-running agent context exhaustion by preserving complete context across sessions.'
---
