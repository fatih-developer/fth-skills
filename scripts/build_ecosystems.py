...
GEN_NOTE = "generated by scripts/build_ecosystems.py from skills/ecosystem-*/references/workflows.json — do not edit by hand"
...
def render_handoffs(skill: str, ecos: dict[str, dict], owners: dict[str, str]) -> str:
    ...
    lines += [
        ...
        f"`workflow`, `created_at`, `inputs`, `summary`, and `next` (see {skill_ref(eco)} → "
        "`references/handoff-contract.md`). If a next skill is not installed, continue with its step from the "
